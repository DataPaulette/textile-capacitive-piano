const int numberOfKeys = 9;
int keys[numberOfKeys] = { 5, 4, 8, 9, 10, 12, A1, A3, A5 };
int notes[numberOfKeys] = { 65, 131, 1598, 1760, 2093, 2349, 262, 880, 33  };
...
void checkPianoKey(int key, int note) {
  ...
  if (touchValue > 2) //if the key is pressed
  {
